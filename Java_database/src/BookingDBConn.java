        ...
        try{
            ...
            if(0 == nRows){
                ...
                while(resultSet.next()){
                    final Booking myBooking = new Booking(resultSet.getInt("guestNo"), resultSet.getInt("hotelNo"), resultSet.getString("dateFrom"), resultSet.getString("dateTo"), resultSet.getInt("roomNo"));
