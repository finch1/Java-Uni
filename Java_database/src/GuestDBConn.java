...
public class GuestDBConn {
    ...
    public static List<Guest> readDataFromDB(String sql) throws SQLException{
        System.out.println(sql);
        List<Guest> myResult = new ArrayList<>();
        try{
            ...
            if(0 == nRows){
                ...
                while(resultSet.next()){
                    final Guest myGuest = new Guest(resultSet.getInt("guestNo"), resultSet.getString("guestName"), resultSet.getString("guestAddress"));
                    myResult.add(myGuest);
                }
            }
